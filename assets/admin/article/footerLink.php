			...
			return {
				...
				read : function() {
					$(this.grid).dataGrid({
						...
						colModel : [
							{display:'ID', name:'a.footer_link_id', width:30, align:'center', css:'num'},
							{display:'类别', width:120, name:'a.type_id', align:'left'},
							{display:'关键字', width:150, name:'a.keywords', align:'left'},
							{display:'链接', name:'a.link_url', align:'left'},
							{display:'target方式', width:80, align:'center'},
							{display:'状态', width:50, name:'a.is_status', align:'center'},
							{display:'链接类型', width:50, name:'a.link_type', align:'center'}
						],
						height:-12,
						useSelect : true
