			...
			return {
				...
				read : function() {
					$(this.grid).dataGrid({
						...
						colModel : [
							{display:'ID', name:'a.type_id', width:30, align:'center', css:'num'},
							{display:'深度', width:30, align:'center'},
							{display:'栏目名称', name:'a.id_tree', align:'left'},
							...
							{display:'修改时间', name:'a.release_date', width:120, align:'center', css:'num'}
						],
						height:-12,
						useSelect : true
