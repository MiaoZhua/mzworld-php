	...
	<div class="control_wrapper">
		...
		<div class="top_control">
			...
			<div class="control_btn">
				<?= \Tools\Auxi::getPowerButton('edit', $this->security, $this->pageId, $this->adminPower, '<div class="save color_btn" title="保存数据"><span>保 存</span></div>', true) ?>
						...
						<tr>
							...
							<td>
								...
								if (strpos($_type, 'radio') !== false) {
									$_temp = explode(':', $_type);
									echo(\Tools\Html::radio($this->pageControl, $m->field_name, $m->synopsis, $this->setting[$_temp[1]], 0));
								} else {
									echo(\Tools\Html::$_type($this->pageControl, $m->field_name, $m->synopsis, null, (strcasecmp('textarea', $_type) == 0 ? 3 : null)));
								}
								?></td>
						</tr>
						<?php
