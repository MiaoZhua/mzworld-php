...
<table width="100%" cellpadding="0" cellspacing="0" class="data_input">
	<tr>
		...
		<td rowspan="3"><?= \Tools\Html::textarea($this->pageControl, 'role_desc', $this->rs, null, 3, null, ' onpropertychange="if(value.length>100) value=value.substr(0,100)"') ?></td>
	</tr>
	<tr>
		<th>修改时间</th>
	...
	<tr>
		<th>角色名称</th>
		<td><?= \Tools\Html::text($this->pageControl, 'role_name', $this->rs) ?></td>
	</tr>
	<tr>
		<th>角色权限</th>
