...
<div id="header">
	<div id="navigation">
		...
		<?= \Admin\Helper::getTopAdminMenu($this->adminMap, $this->session->adminUser['id'], $this->adminPower) ?>
	</div>
	<div class="top_r">
		<dl>
...
<div id="main_copyright">&copy; 2007-<?= date('Y') ?> All rights reserved. <?= $this->cfg['softCore'] . $this->version['phoenix'] ?></div>
...
<script src="<?= $this->__VENDORS__ . $this->cfg['editor_dir'] ?>/kindeditor-min.js"></script>
</body>
</html>
