        ...
        if (typeof PageAction[PageAction.currenPageActionClassName] == 'undefined') {
            PageAction[PageAction.currenPageActionClassName] = function() {
                ...
                return {
                    ...
                    init : function() {
                        var _g = this.grid;
                        $(':input[type=submit], :radio[name=tc_is_display]', _g).click(function(){
                    ...
                    read : function() {
                        $(this.grid).dataGrid({
                            ...
                            params   : [ { name : 'tc_is_display', value : '1' } ],
                            ...
                            colModel : [
                                ...
                                {display:'所属微课', name:'a.tutorial_id', width:200, align:'left'},
                                {display:'章节名称', align:'left'},
                                {display:'章节图片', width:60, align:'center'},
                                {display:'卡片图片', width:60, align:'center'},
                                {display:'视频文件', width:150, align:'center'},
    ...
    <div class="grid_wrapper">
        <div class="m_search_field">
            <form name="search_from" onsubmit="return false;">
                ...
                <?= \Tools\Html::radio(true, 'tc_is_display', '', $this->setting['aryGoodsDisplay'], '1', 'horizontal', 'red b') ?>
            </form>
        </div>
    </div>
