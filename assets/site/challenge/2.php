...
<!--                                    <div class="progress">剩30天</div>-->
    ...
    <div class="challenge_post">
        <div class="challenge_b">
           ...
           <div class="thumbnail" style="margin-bottom:30px;"><img src="<?= $this->__STATIC__ ?>images/content/wuran.jpg" /></div>
             <div class="desc"><div class="p_left"><p class="mb40">想像柴静姐姐一样为城市蓝天出一份自己的力吗？现在就行动起来，从自己做起，从生活的家庭学校做起，让我们一起来畅想可以减少污染恢复蓝天的妙招吧！</p></div></div>
             <div class="desc">
              
              
              <p class="title_style3">社会现状</p>
              <div class="p_left">
              	<p class="mb40">空气污染，又称为大气污染 常是指由于人类活动或自然过程引起某些物质进入大气中，呈现出足够的浓度，达到足够的时间，并因此危害了人类的舒适、健康和福利或环境的现象。在我国，空气污染问题变得越来越严重，雾霾天气持续时间多、范围广、影响大、污染重等特点给人们带来了健康的隐患，威胁着大家的生命安全，因此对于空气污染的治理刻不容缓。</p>
              </div>
              ...
              <p class="mb40">上海禾赛光电科技有限公司成立于2014年11月, 主营业务为高端在线气体分析仪器，可以高精度快速分析混合气体成分，在大气环境监测、工业过程气体检测、危险气体泄漏检测、实验室仪器等领域有广阔的应用前景。</p></div>
              
              <p class="title_style3">项目愿景</p>
              <div class="p_left"><p>我们找到了从硅谷回国创业，抱有改变环境拯救中国的伟大梦想的企业家们。希望在他们的帮助下，大家可以了解更多有关空气污染和治理的知识，同时也可以发挥自己的创造力，从身边的问题入手，想想怎样可以更有效的减少污染。解决身边的环境问题，也许你的创意能够带给我们另一片蓝天！</p></div>
            		...
            		<tr>
            			<td width="360">
            				<div class="gallery_a_l">
				                <a class="button" href="/account/topostzuopinfromchallenge?from=<?php echo $_GET['from']?>&challenge_id=2">参与召集</a>
				            </div>
            			</td>
            			<td width="360">
...
<!--                </li>-->
            ...
            <script>
            	$.post('/mzworld/?c=challenge&m=gethotzuopinlist&from=<?php echo $_GET['from']?>&collenge_id=2',function (data){
...
<!--                </li>-->
            ...
            <script>
            	$.post('/mzworld/?c=challenge&m=getcollengezuopinlist&from=<?php echo $_GET['from']?>&collenge_id=2',function (data){
