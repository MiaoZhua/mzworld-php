...
<div class="post_overflow">
                    ...
                    <div class="box_c">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td class="td_c">
                                    <h3>奇妙随机数-上海市日新实验小学</h3>
                                    <p class="desc">Scratch中的“在1到10间随机选一个数”，你可以帮助我们做好多有趣的游戏和酷炫的效果，一起来玩奇妙的随机数吧</p>
    ...
    <div class="challenge_post">
        <div class="challenge_b">
            ...
            <div class="desc"><div class="p_left" style="padding-left:0px;"><p class="mb40">小朋友你知道随机数吗？在生活中，我们最常见的随机数就是掷骰子，每次都会出现不同的数字，那么随机数在Scratch中有哪些应用呢？想和大家一起来用奇妙的随机数创作各种好玩的游戏吗？还等什么，赶紧加入吧。</p></div></div>
            		...
            		<tr>
            			<td width="360">
            				<div class="gallery_a_l">
				                <a class="button" href="/account/topostzuopinfromchallenge?from=<?php echo $_GET['from']?>&challenge_id=3">参与召集</a>
				            </div>
            			</td>
            			<td width="360">
...
<!--			<div class="files clearboth" style="margin-bottom:100px;">-->
...
<!--                </li>-->
            ...
            <script>
            	$.post('/mzworld/?c=challenge&m=gethotzuopinlist&from=<?php echo $_GET['from']?>&collenge_id=3',function (data){
...
<!--                <li>-->
<!--                    <p class="title clearboth">-->
<!--                        <span class="title_l"><em class="text">飞鱼</em><em class="num">216</em></span>-->
<!--                        <span class="title_r"><img src="<?= $this->__STATIC__ ?>images/home/icon2.png"></span>-->
<!--                    </p>-->
<!--                    <span class="img"><a href="/gallery/321" target="_blank"><img src="<?= $this->__STATIC__ ?>images/delete/01.jpg"></a></span>-->
<!--                </li>-->
<!--                <li>-->
<!--                    <p class="title clearboth">-->
<!--                        <span class="title_l"><em class="text">猴子接物</em><em class="num">132</em></span>-->
<!--                        <span class="title_r"><img src="<?= $this->__STATIC__ ?>images/home/icon4.png"></span>-->
<!--                    </p>-->
<!--                    <span class="img"><a href="/gallery/305" target="_blank"><img src="<?= $this->__STATIC__ ?>images/delete/2.jpg"></a></span>-->
<!--                </li>-->
<!--				<li>-->
<!--                    <p class="title clearboth">-->
<!--                        <span class="title_l"><em class="text">小火箭</em><em class="num">546</em></span>-->
<!--                        <span class="title_r"><img src="<?= $this->__STATIC__ ?>images/home/icon2.png"></span>-->
<!--                    </p>-->
<!--                    <span class="img"><a href="/gallery/310" target="_blank"><img src="<?= $this->__STATIC__ ?>images/delete/7.jpg"></a></span>-->
<!--                </li>-->
<!--                <li>-->
<!--                    <p class="title clearboth">-->
<!--                        <span class="title_l"><em class="text">接鸡蛋</em><em class="num">83</em></span>-->
<!--                        <span class="title_r"><img src="<?= $this->__STATIC__ ?>images/home/icon2.png"></span>-->
<!--                    </p>-->
<!--                    <span class="img"><a href="/gallery/322" target="_blank"><img src="<?= $this->__STATIC__ ?>images/delete/02.jpg"></a></span>-->
<!--                </li>-->
<!--                <li>-->
<!--                    <p class="title clearboth">-->
<!--                        <span class="title_l"><em class="text">求雨来</em><em class="num">92</em></span>-->
<!--                        <span class="title_r"><img src="<?= $this->__STATIC__ ?>images/home/icon4.png"></span>-->
<!--                    </p>-->
<!--                    <span class="img"><a href="/gallery/307" target="_blank"><img src="<?= $this->__STATIC__ ?>images/delete/5.jpg"></a></span>-->
<!--                </li>-->
<!--                <li>-->
<!--                    <p class="title clearboth">-->
<!--                        <span class="title_l"><em class="text">天天酷跑</em><em class="num">214</em></span>-->
<!--                        <span class="title_r"><img src="<?= $this->__STATIC__ ?>images/home/icon5.png"></span>-->
<!--                    </p>-->
<!--                    <span class="img"><a href="/gallery/318" target="_blank"><img src="<?= $this->__STATIC__ ?>images/delete/6.jpg"></a></span>-->
<!--                </li>-->
<!--                <li>-->
<!--                    <p class="title clearboth">-->
<!--                        <span class="title_l"><em class="text">火箭飞来飞去</em><em class="num">56</em></span>-->
<!--                        <span class="title_r"><img src="<?= $this->__STATIC__ ?>images/home/icon5.png"></span>-->
<!--                    </p>-->
<!--                    <span class="img"><a href="/gallery/308" target="_blank"><img src="<?= $this->__STATIC__ ?>images/delete/3.jpg"></a></span>-->
<!--                </li>-->
<!--                <li>-->
<!--                    <p class="title clearboth">-->
<!--                        <span class="title_l"><em class="text">熊二飞飞飞</em><em class="num">46</em></span>-->
<!--                        <span class="title_r"><img src="<?= $this->__STATIC__ ?>images/home/icon4.png"></span>-->
<!--                    </p>-->
<!--                    <span class="img"><a href="/gallery/256" target="_blank"><img src="<?= $this->__STATIC__ ?>images/delete/8.jpg"></a></span>-->
<!--                </li>-->
                <!--<li>
                    <p class="title clearboth">
                        <span class="title_l"><em class="text">雪花</em><em class="num">83</em></span>
                        <span class="title_r"><img src="<?= $this->__STATIC__ ?>images/home/icon5.png"></span>
                    </p>
            ...
            <script>
            	$.post('/mzworld/?c=challenge&m=getcollengezuopinlist&from=<?php echo $_GET['from']?>&collenge_id=3',function (data){
        ...
        <div class="tbox_b clearboth">
        	<div class="scroll">
                <ul class="work_list clearboth">
                    <li class="cur">
                        <span class="title clearboth"><em class="text">蝙蝠飞</em></span>
                        <span class="img"><img src="<?= $this->__STATIC__ ?>images/delete/1.jpg"></span>
                        <i></i>
                    </li>
                    <li>
                        <span class="title clearboth"><em class="text">猴子接物</em></span>
                        <span class="img"><img src="<?= $this->__STATIC__ ?>images/delete/2.jpg"></span>
                        <i></i>
                    </li>
                    <li>
                        <span class="title clearboth"><em class="text">火箭飞来飞去</em></span>
                        <span class="img"><img src="<?= $this->__STATIC__ ?>images/delete/3.jpg"></span>
                        <i></i>
                    </li>
                    <li>
                        <span class="title clearboth"><em class="text">接鸡蛋</em></span>
                        <span class="img"><img src="<?= $this->__STATIC__ ?>images/delete/4.jpg"></span>
                        <i></i>
                    </li>
                    <li>
                        <span class="title clearboth"><em class="text">求雨来</em></span>
                        <span class="img"><img src="<?= $this->__STATIC__ ?>images/delete/5.jpg"></span>
                        <i></i>
                    </li>
                    <li>
                        <span class="title clearboth"><em class="text">天天酷跑</em></span>
                        <span class="img"><img src="<?= $this->__STATIC__ ?>images/delete/6.jpg"></span>
                        <i></i>
                    </li>
                    <li>
                        <span class="title clearboth"><em class="text">小火箭</em></span>
                        <span class="img"><img src="<?= $this->__STATIC__ ?>images/delete/7.jpg"></span>
                        <i></i>
                    </li>
                    <li>
                        <span class="title clearboth"><em class="text">熊二飞飞飞</em></span>
                        <span class="img"><img src="<?= $this->__STATIC__ ?>images/delete/8.jpg"></span>
                        <i></i>
                    </li>
                </ul>
            </div>
