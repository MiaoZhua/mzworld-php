                    ...
                    <div class="box_c">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td class="td_c">
                                    <h3 style="font: bold 26px 'gothamroundedbook','幼圆','Hiragino Sans GB W3';">Happy Scratch Day, Hot Scratch Show</h3>
                                    <p class="desc">首届MZ星球中国区Scratch作品展等你来Show</p>
           ...
           <div class="thumbnail" style="margin-bottom:30px;"><img src="<?= $this->__STATIC__ ?>images/content/happyscratchday.jpg" /></div>
             <div class="desc">
             	<div class="p_left">
					...
					<p class="mb30">而喵爪MZ星球，致力于中国创新教育发展，旨在为孩子们搭建国际化的作品分享社交平台。</p>
					<p class="mb30">为了响应Scratch Day, 首届MZ星球Scratch作品秀上线啦！<br />快来这里感受学习、分享和实践360度一体化编程体验吧！</p>
					<p class="mb30">本次活动由MZ星球和信息教育界权威杂志 《中小学信息技术教育》联合举办 ，是国内首个业界权威和学界权威强强联手推出的高端作品分享秀！</p>
					<p class="mb30">还等什么？！<br />
来加入我们~ 上传你的作品！我们让你被发现！</p>
				</div>
			 </div>
             <div class="desc">
              <p class="title_style3">作品要求</p>
              <div class="p_left">
              	<p class="mb20">
	              	<ul style="list-style-type:circle;">
	              		<li style="list-style-type:circle;">主题明确，切合学习或生活且富有创意的软件作品；</li>
	              		<li style="list-style-type:circle;">需附上简短的自我介绍及作品文字说明（内容包括作者或团队介绍、Scratch作品演示、创作思路、创作过程等）；</li>
	              		<li style="list-style-type:circle;">参与者可是团队或个人 （团队人数不超过3人，队员之间需有分工，体现合作成果）。</li>
	              		<li style="list-style-type:circle;">首届活动支持所有版本</li>
	              		<li style="list-style-type:circle;">活动截止日期：2015年6月15日</li>
	              	</ul>
              	</p>
              </div>
              <p class="mb20">&nbsp;</p>
              <p class="title_style3">评比机制</p>
              <div class="p_left">
              	<p class="mb20">
              		<ul style="list-style-type:circle;">
	              		<li style="list-style-type:circle;">根据作品点赞数，设立十位“最佳人气奖”；</li>
	              		<li style="list-style-type:circle;">奖品：由Scratch权威专家点评及《中小学信息技术教育》颁发的证书和MZ星球提供的超级大礼！</li>
	              	</ul>
              		# 越早上传作品的队伍得到的关注和点赞的机会越多哦！#
        		</p>
              </div>
           <p class="mb20">&nbsp;</p>
            <p class="title_style3">精彩分享，等你来SHOW</p>
           <p class="mb20">&nbsp;</p>
            <p class="title_style3">联系人：</p>
              <div class="p_left"><p class="mb20">技术咨询：Tao  18521503035 <br />
活动咨询：Lina 13671555170</p>
            		...
            		<tr>
            			<td width="360">
            				<div class="gallery_a_l">
				                <a class="button" href="/account/topostzuopinfromchallenge?from=<?php echo $_GET['from']?>&challenge_id=6">参与召集</a>
				            </div>
            			</td>
            			<td width="360">
...
<!--                </li>-->
            ...
            <script>
            	$.post('/mzworld/?c=challenge&m=gethotzuopinlist&from=<?php echo $_GET['from']?>&collenge_id=6',function (data){
...
<!--                </li>-->
            ...
            <script>
            	$.post('/mzworld/?c=challenge&m=getcollengezuopinlist&from=<?php echo $_GET['from']?>&collenge_id=6',function (data){
