...
<div class="gallery">
	...
	<!--                            </li>-->
	                        ...
	                        <script>
				            	$.post('/mzworld/?c=challenge&m=getgalleryzuopinlist&challenge_id=7',function (data){
	...
	<!--                            </li>-->
	                        ...
	                        <script>
				            	$.post('/mzworld/?c=challenge&m=getgalleryzuopinlist&challenge_id=6',function (data){
	...
	<!--                            </li>-->
	                        ...
	                        <script>
				            	$.post('/mzworld/?c=challenge&m=getgalleryzuopinlist&challenge_id=1',function (data){
	...
	<!--                            </li>-->
	                        ...
	                        <script>
				            	$.post('/mzworld/?c=challenge&m=getgalleryzuopinlist&challenge_id=2',function (data){
	...
	<!--                            </li>-->
	                        ...
	                        <script>
				            	$.post('/mzworld/?c=challenge&m=getgalleryzuopinlist&challenge_id=3',function (data){
                ...
                <div class="box_r">
                	<a href="/challenge/4?from=gallery" target="_blank">
	                    ...
	                    <div class="list">
	                        ...
	                        <script>
				            	$.post('/mzworld/?c=challenge&m=getgalleryzuopinlist&challenge_id=4',function (data){
