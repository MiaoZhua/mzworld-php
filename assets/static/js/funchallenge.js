    ...
    fun={
        ...
        moveBlock:function(){
            ...
            $(".sections").delegate(".section","mouseover",function(){
                $(this).find(".close,.close_ckeditor,.move_t,.move_b").show();
            });
            $(".sections").delegate(".section","mouseout",function(){
                $(this).find(".close,.close_ckeditor,.move_t,.move_b").hide();
            });
            $(".sections").delegate(".move_t","click",function(){
                var $this_p=$(this).parent().parent();
                $this_p.insertBefore($this_p.prev());
                $(".sections .section a.close,.sections .section a.close_ckeditor,.sections .section .move_t,.sections .section .move_b").hide();
            });
