...
return array(
    //定义拦截器
    'interceptor' => array(
        'login' => '\Admin\Interceptor\Login',
        'security' => '\Admin\Interceptor\Security',
        'createConfig' => '\Admin\Interceptor\CreateConfig'
    ),
    //拦截器堆栈
    'stack' => array(
        'default' => array(
            ...
            'login' => array(
                'excludeRoute' => array(
                    'admin/system/login', 'handler/Admin.System.Login'
                )
            ),
            'security' => array(
                'excludeRoute' => array(
