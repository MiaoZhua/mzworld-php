...
?>
<form action="<?php echo site_url('admins/'.$this->controller.'/add_subarticle')?>" method="post">
	...
	<tr>
		<td>
			...
			<?php if($is_selection_1==1){?>
				<tr>
					<td width="120" align="right">第一选择&nbsp;&nbsp;</td>
				    <td align="left">
				    	<?php 
				    	...
				    	<select name="selection_1">
				    		<?php if(isset($selection_1list)){for($i=0;$i<count($selection_1list);$i++){?>
				    			<option value="<?php echo $selection_1list[$i]['article_id'];?>"><?php echo $selection_1list[$i]['article_name'.$this->langtype]?></option>
				    		<?php }}?>
				    	</select>
				    </td>
				</tr>
				    ...
				    <td align="left">
				    	...
				    	<select name="selection_2">
				    		<?php if(isset($selection_2list)){for($i=0;$i<count($selection_2list);$i++){?>
				    			<option value="<?php echo $selection_2list[$i]['article_id'];?>"><?php echo $selection_2list[$i]['article_name'.$this->langtype]?></option>
				    		<?php }}?>
				    	</select>
				    </td>
				</tr>
