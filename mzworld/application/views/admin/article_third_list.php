...
<div class="ma_actions">
	<ul>
		<li><b>操作 :</b></li>
		<li>
			<a href="<?php echo site_url('admins/'.$this->controller.'/toadd_town?subcategory_ID='.$subcategory_info['category_id'].'&first_id='.$firstinfo['article_id'].'&second_id='.$secondinfo['article_id'].'&tongji_split='.$tongji_split.'&key='.$subcategory_info['key'])?>"><font class="nav_off">Add Town</font></a>
		</li>
	</ul>
</div>
		...
		<table cellspacing=0 cellpadding=0 class="tab_list">
			<tr>  	
				...
				<td width="200" align="center">
					...
					?>
					<a href="<?php echo site_url('admins/'.$this->controller.'/vallage_list?subcategory_ID='.$subcategory_info['category_id'].'&first_id='.$firstinfo['article_id'].'&tongji_split='.$tongji_split.'&second_id='.$secondinfo['article_id'].'&third_id='.$article[$i]['article_id'].'&key='.$article[$i]['key'])?>">Manage Vallages <?php echo $count_text;?></a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="<?php echo site_url('admins/'.$this->controller.'/toedit_town?subcategory_ID='.$subcategory_info['category_id'].'&first_id='.$firstinfo['article_id'].'&second_id='.$secondinfo['article_id'].'&tongji_split='.$tongji_split.'&ID='.$article[$i]['article_id'].'&key='.$article[$i]['key'].'&backurl='.$current_url_encode)?>"><?php echo lang('cy_edit')?></a>
					&nbsp;&nbsp;&nbsp;&nbsp;
