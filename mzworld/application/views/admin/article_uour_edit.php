...
?>
<form action="<?php echo site_url('admins/'.$this->controller.'/edit_vallage')?>" method="post">
		...
		<td>
			<table width="100%">
				<?php 
					for($la=0;$la<count($langarr);$la++){//多语言
						...
						<tr>
							...
							<td align="left">
								<div style="float:left;"><input type="text" style="width:500px;" name="article_name'.$langarr[$la]['langtype'].'" value="'.$articleinfo['article_name'.$this->langtype].'" /></div>
						    </td>
						</tr>
						';
					}
				...
				<tr>
				    ...
				    <td align="left">
				    	<div style="float:left;"><input type="text" style="width:200px;" name="nolaninput_1" value="<?php echo $articleinfo['nolaninput_1']?>" /></div>
				    </td>
				</tr>
				<tr>
				    <td colspan="2">
				...
				<tr>
				    ...
				    <td align="left">
				    	<div style="float:left;"><input type="text" style="width:200px;" name="nolaninput_2" value="<?php echo $articleinfo['nolaninput_2']?>" /></div>
				    </td>
				</tr>
				<tr>
				    <td colspan="2">
			    ...
			    <tr>
				    ...
				    <td align="left">
				    	...
				    	<input name="subcategory_id" type="hidden" value="<?php echo $subcategory_info['category_id'];?>" />
				   		...
				   		<input name="third_id" type="hidden" value="<?php echo $thirdinfo['article_id'];?>" />
