	...
	<tr>
		<td>
			...
			<?php if(isset($categorylist)){for($i=0;$i<count($categorylist);$i++){?>
				<tr>
					<td>
						<?php echo '<a href="'.site_url('admins/setting/toedit_subcategoryparameter/'.$categorylist[$i]['category_id']).'">'.$categorylist[$i]['category_name'.$this->langtype].'</a>'?>
						<?php $id=$categorylist[$i]['category_id']?>
					</td>
					<td>
						<form action="<?php echo site_url('admins/setting/edit_parameter/'.$id)?>" method="post">
							...
							<tr>
								<td valign="top">
										<?php 
											...
											$con=array('name','created','edited','author','orderby','next','add','edit','del','muldel');
											for($tt=1;$tt<=5;$tt++){
												$con[]='pic_'.$tt;
												$con[]='nolaninput_'.$tt;
												$con[]='laninput_'.$tt;
											...
											$parameter=$categorylist[$i]['parameter_list'];
										...
										<div style="float:left;width:100%;">
											<div style="float:left;margin:6px 0px 0px 0px;">
												<input onclick="toactionparameter_next('<?php echo $id;?>list_next')" type="checkbox" name="<?php echo $id;?>list_next" id="<?php echo $id;?>list_next" value="next" <?php if(${'is_next'}==1){echo 'checked';}?>/> <label for="<?php echo $id;?>list_next">是否跳转到下一级</label> 
											</div>
										</div>
										
										
										
										<div class="<?php echo $id;?>list_next_area" style="<?php if(${'is_next'}==1){echo 'display:none;';}else{echo 'display:block;';}?>">
											<div style="float:left;width:100%;">
												<div style="float:left;margin:6px 0px 0px 0px;">
											...
											<div style="float:left;width:100%;">
												<div style="float:left;margin:6px 0px 0px 0px;">
													<input onclick="toactionparameter_list('<?php echo $id;?>list_selection_1')" type="checkbox" name="<?php echo $id;?>list_selection_1" id="<?php echo $id;?>list_selection_1" value="selection_1" <?php if(${'is_selection_1'}==1){echo 'checked';}?>/> <label for="<?php echo $id;?>list_selection_1">Category</label> 
												</div>
												<div style="float:left;margin:6px 0px 0px 0px;">
													<input onclick="toactionparameter_list('<?php echo $id;?>list_selection_2')" type="checkbox" name="<?php echo $id;?>list_selection_2" id="<?php echo $id;?>list_selection_2" value="selection_2" <?php if(${'is_selection_2'}==1){echo 'checked';}?>/> <label for="<?php echo $id;?>list_selection_2">City</label> 
												</div>
												<div style="float:left;margin:6px 0px 0px 0px;">
											...
											<div style="float:left;width:100%;">
												<div style="float:left;margin:6px 0px 0px 0px;">
													<input onclick="toactionparameter_list('<?php echo $id;?>list_checkboxion_1')" type="checkbox" name="<?php echo $id;?>list_checkboxion_1" id="<?php echo $id;?>list_checkboxion_1" value="checkboxion_1" <?php if(${'is_checkboxion_1'}==1){echo 'checked';}?>/> <label for="<?php echo $id;?>list_checkboxion_1">Tags</label> 
												</div>
												<div style="float:left;margin:6px 0px 0px 0px;">
...
<!--										//模块和名称-->
								...
								<td>
										<?php 
											...
											$parameter=$categorylist[$i]['parameter_post'];
											$parameter=explode('-',$parameter);
										...
										<div class="<?php echo $id;?>list_next_area" style="<?php if(${'is_next'}==1){echo 'display:none;';}else{echo 'display:block;';}?>">
											...
											<div style="float:left;width:100%;">
												<div style="float:left;margin:6px 0px 0px 0px;">
													<input type="checkbox" name="<?php echo $id;?>post_selection_1" id="<?php echo $id;?>post_selection_1" value="selection_1" <?php if(${'is_selection_1'}==1){echo 'checked';}?>/> <label for="<?php echo $id;?>post_selection_1">Category</label> 
												</div>
												<div style="float:left;margin:6px 0px 0px 0px;">
													<input type="checkbox" name="<?php echo $id;?>post_selection_2" id="<?php echo $id;?>post_selection_2" value="selection_2" <?php if(${'is_selection_2'}==1){echo 'checked';}?>/> <label for="<?php echo $id;?>post_selection_2">City</label> 
												</div>
												<div style="float:left;margin:6px 0px 0px 0px;">
											...
											<div style="float:left;width:100%;">
												<div style="float:left;margin:6px 0px 0px 0px;">
													<input type="checkbox" name="<?php echo $id;?>post_checkboxion_1" id="<?php echo $id;?>post_checkboxion_1" value="checkboxion_1" <?php if(${'is_checkboxion_1'}==1){echo 'checked';}?>/> <label for="<?php echo $id;?>post_checkboxion_1">Tags</label> 
												</div>
												<div style="float:left;margin:6px 0px 0px 0px;">
...
<script>
	...
	function toactionparameter_next(id){
		if($('.'+id+'_area').css('display')=='none'){
			$('.'+id+'_area').show();
		}else{
			$('.'+id+'_area').hide();
