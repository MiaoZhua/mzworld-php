...
<div style="float:left;width:100%;font-size:12px;line-height:25px;">
	...
	&gt;&gt; 
	<a href="<?php echo site_url('admins/setting/toedit_subcategoryparameter/'.$categoryinfo['category_id'])?>">子分类列表(<?php echo $subcategoryinfo['category_name'.$this->langtype];?>) </a> 
	&gt;&gt; 文章列表
	...
	<tr>
		<td>
			...
			<?php if(isset($articlelist)){for($i=0;$i<count($articlelist);$i++){?>
				<tr>
					<td>
						<?php echo '<a href="'.site_url('admins/setting/toedit_articleparameter/'.$categoryinfo['category_id'].'/'.$subcategoryinfo['category_id']).'">'.$articlelist[$i]['article_name'.$this->langtype].'</a>'?>
						<?php $id=$articlelist[$i]['article_id']?>
					</td>
					<td>
						<form action="<?php echo site_url('admins/setting/edit_articleparameter/'.$categoryinfo['category_id'].'/'.$subcategoryinfo['category_id'].'/'.$id)?>" method="post">
							...
							<tr>
								<td valign="top">
										<?php 
											...
											$parameter=$articlelist[$i]['parameter_list'];
...
<!--										//模块和名称-->
								...
								<td>
										<?php 
											...
											$parameter=$articlelist[$i]['parameter_post'];
											$parameter=explode('-',$parameter);
